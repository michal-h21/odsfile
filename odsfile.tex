...
documents\thanks{Version 0.10, last revisited 2025-10-31.}
}
...
\begin{description}
  \item [v0.10]
    \begin{itemize}
      \item define Lua functions locally, to prevent pollution of global namespace\footnote{Thanks to Udi Fogiel}
    \end{itemize}
  \item [v0.9]
    \begin{itemize}
